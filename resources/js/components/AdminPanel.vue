<template>
    <div>
        <div class="container ">
            ...
            data-target="#addFacture" class="btn mt-5 btn-sm btn-success text-white mb-2">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            >
                             ...
                             <router-link  :to="{path:'facture/edit/'+facture.facture_code}" class="btn mr-1 btn-sm btn-primary">
                                <div class="fa fa-eye"> </div>
                                   </router-link>

                                <router-link  :to="{path:'facture/edit/'+facture.id}" class="btn mr-1 btn-sm btn-warning">
                      ...
                      <div class="card-footer d-flex justify-content-center">
                         <pagination :data="factures" @pagination-change-page="getfacture"></pagination>
                    </div>
                </div>
            </div>
         ...
         supprimerfacture(facture){
            ...
            Swal.fire({
             ...
             cancelButtonColor:'#d33'
                  ...
                  if(result.value)
                  {
                      axios.delete(`api/facture/${facture}`)
                      .then(response=> {
            Swal.fire({
               position: 'center ',
              icon: 'success',
